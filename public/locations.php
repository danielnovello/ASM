...
<div class="container">
	...
	<div class="well" style="margin:auto; padding:auto; width:100%;">
		...
		<br>
		 <span class="pull-left"><a href="#addnewloc" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New</a></span>
		 <span style="padding-left:5px" class="pull-right"><a href="#exportlocations" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-share"></span>  Export</a></span>
		 <span class="pull-right"><a href="#importloc" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-share"></span>  Import</a></span>
		<div style="height:50px;"></div>
			...
			<?php
				...
				while($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td>
							<a href="#editloc<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
							<a href="#deleteloc<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
