...
if($imageFileName != "students.csv" ) {
	echo "<img src='img/cross.png' width='100'/>";
	echo "<br><br>";
    echo "Sorry, only students.csv is allowed.";
    $uploadOk = 0;
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        if (empty($_POST["dumpstudents"]) ) 
			...
			while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
				$sqlInsertappend = "INSERT into students (students_person_id, students_person_number, students_first_name, students_middle_name, students_last_name, students_grade_level, students_email_address, students_sis_username, students_password_policy, location_id)
