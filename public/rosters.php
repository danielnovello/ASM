...
<div class="container">
	...
	<div class="well" style="margin:auto; padding:auto; width:100%;">
		...
		<br>
		<span class="pull-left"><a href="#addnewrosters" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New</a></span>
		 <span style="padding-left:5px" class="pull-right"><a href="#exportrosters" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-share"></span>  Export</a></span>
		 <span class="pull-right"><a href="#importrosters" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-share"></span>  Import</a></span>
		<div style="height:50px;"></div>
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				$query=mysqli_query($conn,"select * from `rosters`");
				while($row=mysqli_fetch_array($query)){
					...
					<tr>	
						...
						<td>
							<a href="#editrosters<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
							<a href="#deleterosters<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
