...
<div class="container">
	...
	<div class="well" style="margin:auto; padding:auto; width:100%;">
		...
		<br>
		<span class="pull-left"><a href="#addnewclasses" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New</a></span>
		 <span style="padding-left:5px" class="pull-right"><a href="#exportclasses" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-share"></span>  Export</a></span>
		 <span class="pull-right"><a href="#importclasses" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-share"></span>  Import</a></span>
		<div style="height:50px;"></div>
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				while($row=mysqli_fetch_array($query)){
					?>
					<tr>	
						<td><?php echo $row['classes_class_id']; ?></td>
						<td><?php echo $row['classes_class_number']; ?></td>
						<td><?php echo $row['classes_course_id']; ?></td>
						<td><?php echo $row['classes_instructor_id']; ?></td>
						<td><?php echo $row['classes_instructor_id_2']; ?></td>
						<td><?php echo $row['classes_instructor_id_3']; ?></td>
						<td><?php echo $row['location_id']; ?></td>
						<td>
							<a href="#editclasses<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
							<a href="#deleteclasses<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
